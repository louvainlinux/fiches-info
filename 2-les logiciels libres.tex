...
Je vais maintenant vous donner une petite liste de logiciels propriétaires avec leur équivalent libres multi-plateforme (pour Windows, MacOSX et GNU/Linux). %% ou faire un tableau?
\begin{itemize}
	...
	\item À la place d'Adobe Reader, vous pouvez utiliser Sumatra (Windows) ou Evince (Linux) pour lire vos PDF et bien d'autres formats. %% Xpdf, c'est un peu vieux...
	\item Pour ceux qui font de la modélisation 3D sur Maya, Blender est là pour vous.
	\item Avis aux fans de musiques, au lieu de passer par iTunes, vous pouvez utiliser Clementine. % aux possesseurs d'iPod
